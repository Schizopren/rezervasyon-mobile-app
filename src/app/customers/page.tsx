        ...
        <div className="bg-white rounded-lg shadow-sm">
          {isLoading ? (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500">Kişiler yükleniyor...</p>
            </div>
          ) : customersList.length === 0 ? (
            <div className="p-8 text-center">
              <Users className="w-12 h-12 text-gray-400 mx-auto mb-4" />
              <h3 className="text-lg font-medium text-gray-900 mb-2">Henüz kişi eklenmemiş</h3>
              <p className="text-gray-500">İlk kişiyi eklemek için "Yeni Kişi Ekle" butonuna tıklayın.</p>
            </div>
          ) : (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {customersList.map((customer) => (
                    <tr key={customer.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{customer.reference || '-'}</div>
                      </td>
